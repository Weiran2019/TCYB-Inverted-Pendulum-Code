...
%%different upper bounds of network-induced delay
...
%%Find the top and bottom margin of the stable interval of network-induced 
%%delay
t=0:0.02:15;
tn=15:-0.02:0;
bot=zeros(1,751);
...
%%Plot the cart positions with different upper bounds of the network-induced
%%delay in figure 9, and plot pendulum angles with different upper bounds 
%%of the network-induced delay in figure 10.
figure(9);
...
l3=legend('Stable $\tau$ interval','$\tau = 0.014s$','$\tau = 0.018s$','$\tau = 0.024s$','$\tau = 0.025s$','$\tau = 0.026s$');
